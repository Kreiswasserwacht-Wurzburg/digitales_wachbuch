...
namespace DigitalGuardBook.GraphQL
{
    ...
    {
        public DigitalGuardBookQuery(IPersonRepository personRepository, IOrganisationRepository organisationRepository, IStationRepository stationRepository, ISentryRepository sentryRepository, ILogBookRepository logBookRepository)
        {
